...
from apps.outbox.routing import websocket_urlpatterns as outbox_websocket_urlpatterns  # noqa: E402
from apps.messaging.routing import websocket_urlpatterns as messaging_websocket_urlpatterns  # noqa: E402

application = ProtocolTypeRouter({
    "http": django_asgi_app,
    "websocket": JWTAuthMiddlewareStack(
        URLRouter(outbox_websocket_urlpatterns + messaging_websocket_urlpatterns)
    ),
})
